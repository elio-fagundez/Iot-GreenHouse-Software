...
export default function Page() {
  ...
  const deleteGreenhouse = async (id: number) => {
    try {
      const apiUrl = process.env.NEXT_PUBLIC_API_URL;
      const response = await fetch(`${apiUrl}/api/co2/${id}`, {
        method: 'DELETE',
      });
  ...
  return (
    <>
      ...
      <HeaderCompanies title="Co2" onSearch={handleSearch} />
              ...
              <TableCell>
                <div className="flex items-center space-x-2">
                  <Dialog open={openModalEditIndex === index} onOpenChange={(isOpen) => setOpenModalEditIndex(isOpen ? index : null)}>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        <DialogTitle>Edit CO2</DialogTitle>
                        <DialogDescription>Edit and configure your CO2</DialogDescription>
                      </DialogHeader>
