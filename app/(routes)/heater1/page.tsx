...
export default function Page() {
  ...
  return (
    <>
      <HeaderCompanies title="Heater 1" onSearch={handleSearch} />
              ...
              <TableCell>
                <div className="flex items-center space-x-2">
                  <Dialog open={openModalEditIndex === index} onOpenChange={(isOpen) => setOpenModalEditIndex(isOpen ? index : null)}>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        <DialogTitle>Edit Heater 1</DialogTitle>
                        <DialogDescription>Edit and configure your Heater 1</DialogDescription>
                      </DialogHeader>
