...
export default function AboutFeatureSection() {
  const features = [
    ...
    },
    {
      ...
      description:
        "We design every detail so that anyone can access a professional control and monitoring system without technical barriers.",
    },
    {
      icon: <Cloud className="w-6 h-6 text-[#00A651]" />,
      title: "Sustainability",
      description:
        "We prioritize solutions that optimize the use of water, energy and other essential resources for responsible cultivation.",
    },
    {
    ...
    <section className="py-16 px-4 max-w-7xl mx-auto">
      <div className="text-center mb-16 space-y-4">
        ...
        <p className="text-lg text-gray-400 max-w-3xl mx-auto">
          We invite you to discover how Bloomiot can revolutionize the way you
          grow. Our team is ready to guide and help you optimize your
          greenhouse, giving you full control of your crops, no matter where you
          are. Welcome to a new era of smart farming!
        </p>
      </div>
