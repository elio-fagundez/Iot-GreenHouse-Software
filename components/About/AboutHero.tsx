        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            <p className="mb-8 text-lg text-white/90">
              Growlink is your trusted partner, providing cutting-edge technology to optimize every aspect of
              cultivation. We&apos;re revolutionizing the industry with smart solutions that drive growth, improve
