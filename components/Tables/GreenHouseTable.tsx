    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          {currentItems.some((item) => item.country) && (
            <TableHead>Country</TableHead>
          )}
          {currentItems.some((item) => item.phone) && (
            <TableHead>Phone</TableHead>
          )}
          {currentItems.some((item) => item.cif) && <TableHead>CIF</TableHead>}
          {currentItems.some((item) => item.website) && (
      ...
      <TableBody>
        {currentItems.map((greenhouse, index) => (
          <TableRow key={greenhouse.id}>
            ...
            {greenhouse.value && (
              <TableCell>{greenhouse.value ?? "N/A"}</TableCell>
            )}
            {greenhouse.createdAt && (
              <TableCell>
                {greenhouse.createdAt
                  ? new Date(greenhouse.createdAt).toLocaleString("en-US")
                  : "N/A"}
              </TableCell>
            )}
            ...
            <TableCell>
              ...
              >
                ...
                <DialogContent>
                  ...
                  <FormCreateCustomer
                    greenhouseData={currentItems[index]}
