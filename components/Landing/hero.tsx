  ...
  useEffect(() => {
    if (isLoaded) {
      ...
      particles.forEach((particle) => {
        ...
        ).style.animation = `moveParticle ${duration}s infinite alternate`;
      });
    }
  }, [isLoaded]);
    ...
    <section className="py-44 mt-20">
      <div className="container flex flex-col items-center text-center">
        ...
        <div className="mt-10 flex items-center gap-6">
          <Link
            href={"/about"}
            className="rounded-full bg-zinc-100 px-6 py-2.5 text-sm font-semibold text-black hover:bg-zinc-200 "
          >
            About us
          </Link>
