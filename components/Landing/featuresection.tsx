...
export default function FeatureSection() {
  const features = [
    ...
    },
    {
      ...
      description:
        "The internal software that controls the devices can be adapted to different growing needs. Whether your greenhouse is small or needs more advanced automations, our firmware adjusts to give you the best performance.",
    },
    {
      icon: <Cloud className="w-6 h-6 text-[#00A651]" />,
      title: "Intuitive Graphical Interface",
      description:
        "Our web platform and mobile app are designed so that anyone, regardless of technical experience, can review and adjust key variables (temperature, humidity, irrigation, etc.) through clear graphics and simple menus.",
    },
    {
    ...
    <section id="services" className="py-16 px-4 max-w-7xl mx-auto bg-white">
      <div className="text-center mb-16 space-y-4">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Our sensors and control devices are easy to connect and install,
          without the need for complicated configurations. Just plug in the
          equipment, sync it with the platform and start monitoring your
          greenhouse in minutes.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((feature, index) => (
          <Card
            key={index}
            className="relative border-0 shadow-lg hover:scale-[1.02] transition-all"
          >
